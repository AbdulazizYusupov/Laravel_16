                        ...
                        <tr>
                            ...
                            <th>
                                <input type="text" class="form-control" placeholder="Search by title"
                                       wire:model="searchTitle" wire:keydown="searchColumps">
                            </th>
                            <th>
                                <input type="text" class="form-control" placeholder="Search by description"
                                       wire:model="searchDesc" wire:keydown="searchColumps">
                            </th>
                            <th>
                                <select class="form-select" wire:model="searchCat" wire:change="searchColumps">
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}">{{$category->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        @foreach($models as $model)
                            ...
                            <tr>
                                @if($editId == $model->id)
                                    <td>{{$model->id}}</td>
                                    <td>
                                        <input type="text" class="form-control" placeholder="Edit by title"
                                               wire:model="editTitle">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" placeholder="Edit by Description"
                                               wire:model="editDesc">
                                    </td>
                                    <td>
